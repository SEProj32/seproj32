    ...
    if (err) {throw err
     ...
     connection.query('SELECT * from teacher', function (error, results, fields) {
       ...
       var mailOptions = {
         ...
         to: mail,
         subject: 'Your assigned inviligation duty',
         text: 'The invigilation duty details are there in your website.For further details contact:323432133 .Please do not reply to this mail,an auto generated mail. '
       };
...
connection.query('update allocation set invigilator= "'+cname+'"  where invigilator= "'+name+'" and date="'+date+'"', function (err, result, fields) {
 ...
 var sno=''
   connection.query('SELECT * from upd', function (error, results, fields) {
    ...
    console.log(sno)
    connection.query("delete  from upd where s_no='"+sno+"' ", function (error, results, fields) {
      if (error) throw error;
      var length=results.length
       }); 
   });
   ...
   connection.query('SELECT * from teacher', function (error, results, fields) {
     ...
     var mailOptions = {
       ...
       text: 'As per Your request Your swapped. contact:323432133 .Please do not reply to this mail,an auto generated mail. '
     };
...
connection.query('SELECT * from teacher', function (error, results, fields) {
  ...
  var mailOptions = {
    from: 'trialacc1140@gmail.com',
    to: mail,
    subject: 'Your request for modification has been rejected',
    text: 'The modification request which u placed is not possible.For further details contact:323432133 .Please do not reply to this mail,an auto generated mail. '
  };
